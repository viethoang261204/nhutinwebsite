...
(function(){
    ...
    function setLanguage(lang) {
        ...
        var toggle = document.querySelector('[data-toggle-lang] .lang-toggle');
        if (toggle) {
            toggle.textContent = (lang === 'vi') ? 'VI' : 'EN';
            console.log('🔄 Button shows current lang:', toggle.textContent);
        }
    }

    function initLanguage() {
        var stored = localStorage.getItem('site_lang') || 'vi';
    ...
    var observer = new MutationObserver(function(mutations) {
        ...
        if (hasNewI18n) {
            var current = document.body.getAttribute('data-lang') || 'vi';
            console.log(' New i18n elements detected, re-translating...');
